...
Overall = pickle.load(open(
    'D:\Disk_4\Projects\Cricket auction\CrickBid_vite\CrickbidServer\Overall_Model.pickle', 'rb'))
Recent = pickle.load(open(
    'D:\Disk_4\Projects\Cricket auction\CrickBid_vite\CrickbidServer\Recent_Model.pickle', 'rb'))
Home = pickle.load(open(
    'D:\Disk_4\Projects\Cricket auction\CrickBid_vite\CrickbidServer\Home_Model.pickle', 'rb'))
Away = pickle.load(open(
    'D:\Disk_4\Projects\Cricket auction\CrickBid_vite\CrickbidServer\Away_Model.pickle', 'rb'))
